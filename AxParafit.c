...
int main (int argc, char *argv[])
{
  ...
  a = (char **)malloc(sizeof(char *) * (size_t)n1);

  for(i = 0; i < n1; i++)    
    a[i] = (char *)malloc(sizeof(char) * (size_t)n2);

  b = (double **)malloc(sizeof(double *) * (size_t)n4);

  for(i = 0; i < n4; i++)    
    b[i] = (double *)malloc(sizeof(double) * (size_t)n1);
  
  CAprime = (double **)malloc(sizeof(double *) * (size_t)n3);

  for(i = 0; i < n3; i++)    
    CAprime[i] = (double *)malloc(sizeof(double) * (size_t)n1);

  c = (double **)malloc(sizeof(double *) * (size_t)n3);

  for(i = 0; i < n3; i++)    
    c[i] = (double *)malloc(sizeof(double) * (size_t)n2);
  ...
  /*printf("Sum of squared PCoA eigenvalues of B = %1.5f\n\n", ssqeigvB);
    printf("Sum of squared PCoA eigenvalues of C = %1.5f\n\n", ssqeigvC);*/
